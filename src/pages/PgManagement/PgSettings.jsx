...
export default function PgSettings({ draftId, pg, onUpdate }) {
  const navigate = useNavigate();
  const [isPublished, setIsPublished] = useState(pg?.draftStatus?.toLowerCase() === 'published');
  ...
  const handleTogglePublish = async () => {
    try {
      ...
      if (response.success) {
        ...
        toast.success(`PG/Hostel ${isPublished ? 'unpublished' : 'published'} successfully`);
        onUpdate();
      } else {
  ...
  const handleArchive = async () => {
    try {
      ...
      if (response.success) {
        toast.success('PG/Hostel archived successfully');
  ...
  const handleDelete = async () => {
    try {
      ...
      if (response.success) {
        toast.success('PG/Hostel deleted successfully');
        navigate('/list-pg-hostel');
      } else {
  ...
  const copyPgLink = () => {
    navigator.clipboard.writeText(pgUrl);
    setCopied(true);
    toast.success('PG/Hostel link copied to clipboard');
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: pg?.draftData?.pgName || 'PG/Hostel Listing',
          text: 'Check out this PG/Hostel',
          url: pgUrl,
        });
      } catch (error) {
    ...
    <div className="space-y-6 pb-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  Manage visibility, notifications, and other settings
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <Card className="overflow-hidden border-2 hover:border-blue-200 dark:hover:border-blue-900 transition-colors">
          <div className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-950/20 dark:to-cyan-950/20 border-b border-blue-100 dark:border-blue-900">
            <CardHeader>
              ...
              <CardDescription>
                Control how your listing appears to potential customers
              </CardDescription>
            </CardHeader>
          </div>
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-2 flex-1">
                  <div className="flex items-center gap-2">
                    <Label className="text-base font-semibold">PG/Hostel Status</Label>
                    {isPublished && (
                      <motion.div
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                    {isPublished 
                      ? '🎉 Your PG/Hostel is live and visible to everyone'
                      : '📝 Your PG/Hostel is in draft mode and not visible to others'
                    }
                  </p>
                  {isPublished && (
                    <motion.div
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Display this PG/Hostel on map-based search results
                  </p>
                </div>
                <Switch 
                  checked={showOnMap} 
        ...
        <Card className="overflow-hidden border-2 hover:border-blue-200 dark:hover:border-blue-900 transition-colors">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 border-b border-blue-100 dark:border-blue-900">
            <CardHeader>
              ...
              <CardDescription>
                Stay updated on new leads and listing activity
              </CardDescription>
            </CardHeader>
          </div>
          <CardContent className="space-y-6 pt-6">
            ...
            <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  💬 Get instant SMS alerts for urgent inquiries
                </p>
              </div>
              <Switch 
        ...
        <Card className="overflow-hidden border-2 hover:border-purple-200 dark:hover:border-purple-900 transition-colors">
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/20 dark:to-pink-950/20 border-b border-purple-100 dark:border-purple-900">
            <CardHeader>
              ...
              <CardDescription>
                Share your listing with potential tenants
              </CardDescription>
            </CardHeader>
          </div>
        ...
        <Card className="border-2 border-red-200 dark:border-red-900 overflow-hidden shadow-lg">
          <div className="bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-950/20 dark:to-orange-950/20 border-b-2 border-red-200 dark:border-red-900">
            <CardHeader>
              ...
              <CardDescription>
                ⚠️ Irreversible actions that permanently affect this listing
              </CardDescription>
            </CardHeader>
          </div>
          <CardContent className="space-y-4 pt-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 leading-relaxed">
                    Hide this listing from all searches. You can restore it later from your archived listings.
                  </p>
                </div>
              </div>
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="text-base">
                      This listing will be hidden from all searches. You can restore it later from your archived listings.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 leading-relaxed">
                    Permanently delete this listing. This action cannot be undone and will remove all associated data.
                  </p>
                </div>
              </div>
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="text-base space-y-2">
                      ...
                      <p>
                        This will permanently delete the listing and all associated data including:
                      </p>
