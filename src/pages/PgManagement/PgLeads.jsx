...
export default function PgLeads({ draftId, pg }) {
  ...
  const loadLeads = async (currentPage = 1, resetPage = false) => {
    try {
      ...
      const response = await pgHostelApi.getPgLeads(draftId, {
        page: currentPage,
        pageSize,
        ...filters,
      });
        ...
        const mockLeads = [
          {
            ...
            reason: 'VIRTUAL_TOUR',
            status: 'NEW',
            listingId: pg?.draftId || draftId,
            listingTitle: pg?.draftData?.pgName || 'PG/Hostel',
            customerName: 'Rahul Verma',
            customerEmail: 'rahul.verma@email.com',
            customerPhone: '+91 98765 43210',
            message: 'Interested in viewing the PG this weekend.',
            createdAt: '2026-01-07T10:30:00Z',
            scheduledDate: '2026-01-11T15:00:00Z',
          ...
          },
          {
            ...
            message: 'Looking for accommodation near my office. Can you share more details?',
          ...
          },
          {
            ...
            message: 'Ready to move in. Please call me.',
          ...
          },
          {
            ...
            message: 'What are the room facilities? Is food included?',
          ...
          },
          {
            ...
            message: 'Looking for hostel accommodation for 6 months.',
            createdAt: '2026-01-03T11:30:00Z',
            scheduledDate: '2026-01-09T11:00:00Z',
            location: 'Delhi, NCR',
          },
        ];

        const filteredData = filterDummyData(mockLeads, filters);
        const startIndex = (currentPage - 1) * pageSize;
        const endIndex = startIndex + pageSize;
        const paginatedLeads = filteredData.slice(startIndex, endIndex);
  ...
  const handleStatusUpdate = async (leadId, newStatus) => {
    try {
      const response = await pgHostelApi.updateLeadStatus(leadId, newStatus);
      if (response.success) {
  ...
  const exportLeads = () => {
    ...
    a.href = url;
    a.download = `pg-leads-${draftId}-${Date.now()}.csv`;
    a.click();
          ...
          <div className="flex gap-3 min-w-max">
            ...
            <div className="flex-shrink-0 flex items-end gap-2">
              <Button
                ...
                size="sm"
                className="h-9 bg-blue-600 hover:bg-blue-700 whitespace-nowrap"
              >
            ...
            >
              ...
              <p className="text-gray-600 mb-6 max-w-md mx-auto">
                ...
                filters.status !== "all"
                  ...
                  : "No leads available for this PG/Hostel at the moment."}
              </p>
            </motion.div>
          ) : (
            <>
