...
export default function PgAnalytics({ draftId, pg }) {
        ...
        setAnalytics({
          views: {
            ...
            daily: [
              ...
              { date: 'Jan 3', value: 142 },
              { date: 'Jan 4', value: 198 },
              { date: 'Jan 5', value: 167 },
              { date: 'Jan 6', value: 189 },
              { date: 'Jan 7', value: 217 },
            ],
          },
          bounceRate: {
            total: 42.3,
            ...
            trend: 'down',
            daily: [
              { date: 'Jan 1', value: 45.2 },
              { date: 'Jan 2', value: 43.8 },
              { date: 'Jan 3', value: 46.1 },
              { date: 'Jan 4', value: 41.5 },
              { date: 'Jan 5', value: 42.9 },
              { date: 'Jan 6', value: 40.7 },
              { date: 'Jan 7', value: 39.8 },
            ],
          },
          conversionRate: {
            total: 7.14,
            ...
            trend: 'up',
            daily: [
              { date: 'Jan 1', value: 6.4 },
              { date: 'Jan 2', value: 6.7 },
              { date: 'Jan 3', value: 6.3 },
              { date: 'Jan 4', value: 7.5 },
              { date: 'Jan 5', value: 7.2 },
              { date: 'Jan 6', value: 7.8 },
              { date: 'Jan 7', value: 8.1 },
            ],
          },
          averageTimeOnPage: {
            total: 154,
            ...
            trend: 'up',
            daily: [
              { date: 'Jan 1', value: 142 },
              { date: 'Jan 2', value: 148 },
              { date: 'Jan 3', value: 139 },
              { date: 'Jan 4', value: 156 },
              { date: 'Jan 5', value: 151 },
              { date: 'Jan 6', value: 163 },
              { date: 'Jan 7', value: 171 },
            ],
          },
        });
        setLoading(false);
  ...
  const statsCards = [
    {
      ...
      icon: Eye,
      description: 'Total PG/Hostel page views',
      color: 'blue',
    ...
    },
    {
      ...
      icon: Clock,
      description: 'Average time on listing page',
      color: 'purple',
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Track your listing's performance and engagement
              </p>
            </div>
          </div>
