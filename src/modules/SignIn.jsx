    ...
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-orange-50 via-orange-100 to-orange-200 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          >
            {[
              { icon: Building2, text: "List unlimited properties", gradient: "from-orange-500 to-orange-600" },
              { icon: Shield, text: "Secure & trusted platform", gradient: "from-blue-500 to-blue-600" },
              { icon: Sparkles, text: "Advanced analytics & insights", gradient: "from-purple-500 to-purple-600" },
            ].map((feature, index) => (
              <motion.div
                key={index}
        ...
        >
          <Card className="w-full max-w-md shadow-2xl border-2 border-orange-200/50 bg-white/95 backdrop-blur-sm overflow-hidden lg:block hidden">
            {/* Decorative Top Bar */}
          ...
          {/* Mobile Sign In - No Card */}
          <div className="lg:hidden w-full max-w-md space-y-6 px-4">
            {/* Mobile Logo */}
            <motion.div
              initial={{ scale: 0.8 }}
              animate={{ scale: 1 }}
            ...
            >
              <Button
                ...
                disabled={isLoading}
                variant="outline"
                className="w-full h-14 text-base font-bold border-2 border-gray-300 hover:border-orange-400 bg-white/90 backdrop-blur-sm hover:bg-orange-50 transition-all duration-300 shadow-lg hover:shadow-xl group relative overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-orange-500/0 via-orange-500/5 to-orange-500/0 group-hover:via-orange-500/10 transition-all duration-300" />
                <svg className="mr-3 h-6 w-6 relative z-10" viewBox="0 0 24 24">
                  <path
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-gradient-to-br from-orange-50 via-orange-100 to-orange-200 text-gray-500 font-medium">
                  OR
                </span>
              </div>
            </div>
